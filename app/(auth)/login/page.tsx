...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      /*
       * The login Edge Function is responsible for authenticating
       * the user and rejecting unverified accounts.
       *
       * The returned authentication session is handled by the
       * auth layer. After successful login, continue to the
      ...
      <section className="auth-section">
        <div className="auth-container">
          <div className="auth-card login-card">
            <div className="auth-card-header">
              ...
              <div className="auth-heading">
                <h1>Welcome back</h1>
                <p>
                  Log in to manage your business and continue growing
                  with IFC BIZGROWTH.
                </p>
              </div>
            </div>
          ...
          <div className="auth-bottom">
            <Link href="/">Back to IFC BIZGROWTH</Link>
          </div>
        </div>
      </section>
    </main>
